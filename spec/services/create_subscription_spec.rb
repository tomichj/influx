  ...
  describe CreateSubscription do
    describe '#call' do
      ...
      it 'creates a subscription' do
        subscription = Influx::CreateSubscription.call(plan: @plan, subscriber: @subscriber, token: @token)
      ...
      it 'calls the activate subscription service' do
        ...
        Influx::CreateSubscription.call(plan: @plan, subscriber: @subscriber, token: @token)
      end
    end
  end
end
